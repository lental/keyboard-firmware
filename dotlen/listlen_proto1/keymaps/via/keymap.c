...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   */
[_BL] = LAYOUT(
  KC_GRAVE, KC_1   , KC_2   , KC_3, KC_4, KC_5   , KC_6  , KC_7   , KC_8   , KC_9 , KC_0, KC_MINUS,KC_EQUAL, KC_BSPC,                        MO(_FL), KC_PSLS, KC_PAST, KC_PMNS,   
  ...
  KC_LCTL, KC_LGUI, KC_LALT,            KC_SPC,KC_SPC, KC_SPC           , KC_RALT, KC_RGUI, KC_RCTRL , KC_LEFT, KC_DOWN, KC_RGHT,         KC_P0, KC_PDOT, KC_PENT),
